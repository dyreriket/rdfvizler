...
public class SauCLI {
    ...
    private Sau rdfvizler;

    private String outputPath;
    private String outputFormat;
    
    public SauCLI(PrintStream out) {
        console = out;
    }
    ...
    private Options buildOptions() {
        ...
        options.addOption(CLI.buildOption("if", OPT_INFORMAT, false,  1, 
                ...
                StringUtils.join(Sau.INPUT_FORMATS, "|"), 
                ". Defaults to: ", Sau.DEFAULT_INPUT_FORMAT));
        ...
        options.addOption(CLI.buildOption("of", OPT_OUTFORMAT, false, 1, 
                ...
                " for dot image output: ", StringUtils.join(Sau.DOT_OUTPUT_FORMATS, "|"), 
                "; for dot text output: ", StringUtils.join(Sau.TEXT_OUTPUT_FORMATS, "|"),
                "; for RDF output: ", StringUtils.join(Sau.RDF_OUTPUT_FORMATS, "|"),
                " Defaults to: ", Sau.DEFAULT_OUTPUT_FORMAT));
    ...
    protected boolean parseOptions(String[] args) {
        ...
        try {
            ...
            cl.consumeOption(OPT_IN,        v -> rdfvizler = new Sau(v));
            ...
            cl.consumeOption(OPT_OUTFORMAT, v -> this.outputFormat = v, Sau.DEFAULT_OUTPUT_FORMAT);
    ...
    private void printHelp(Options options, Exception e) {
        ...
        String str = StringUtils.join(
            " --", OPT_IN, " <rdfFile>", 
            " [--", OPT_RULES, " <rulesFile>]",
            " [--", OPT_INFORMAT, " <", StringUtils.join(Sau.INPUT_FORMATS, "|"), ">]",
            " [--", OPT_OUT, " <outputFile>",
            " --", OPT_OUTEXT, "]",
            " [--", OPT_OUTFORMAT, 
                " <",
                StringUtils.join(Sau.DOT_OUTPUT_FORMATS, "|"),
                "|" + StringUtils.join(Sau.TEXT_OUTPUT_FORMATS, "|"), 
                "|" + StringUtils.join(Sau.RDF_OUTPUT_FORMATS, "|"),
                ">]");
